        ...
        <div class="col-md-12">
          <div class="tile">
            <div class="row">
              <div class="col-lg-4 offset-lg-1">
                <form>
                  ...
                  <div class="form-group">
                    <fieldset disabled="">
                      <label class="control-label" for="disabledInput">Ngày sinh</label>
                  ...
                  <div class="form-group">
                    <fieldset disabled="">
                      <label class="control-label" for="disabledInput">Số điện thoại</label>
            ...
            <div class="tile-footer">
              <a href="{{route('form-thong-tin-ca-nhan-ad',$thongtin->id)}}" role="button" class="btn btn-primary">Chỉnh sửa</a>
            </div>
          </div>
        </div>
      </div>
