...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="{{route('index-ad',$id)}}">E-Learning Admin</a>
          ...
          <div class="tile">
            ...
            <div class="col-lg-6">
                ...
                <div class="tile-footer">
                    <button type="submit" class="btn btn-primary" onclick="return confirm('Bạn có chắc không?')">Thêm tài khoản</button>
                </div>
                </form>
              </div>
            </div>
